...
const preview_link = [
    { title: 'VueJs Version', img: icon1, url: 'https://www.wrappixel.com/templates/flexy-vuetify-dashboard/?ref=376#demos' },
    { title: 'Angular Preview', img: icon2, url: 'https://www.wrappixel.com/templates/flexy-material-angular-admin/?ref=376#demos' },
    { title: 'Nextjs Preview', img: icon3, url: 'https://www.wrappixel.com/templates/flexy-nextjs-dashboard-material-ui/?ref=376#demos' },
    {
        title: 'Reactjs Preview',
        img: icon4,
        url: 'https://www.wrappixel.com/templates/flexy-react-material-dashboard-admin/?ref=376#demos'
    },
    {
        title: 'Nuxtjs Preview',
        img: icon5,
        url: 'https://www.wrappixel.com/templates/flexy-nuxt-js-vuetify-admin-template/?ref=376#demos'
    },
    { title: 'Bootstrap Preview', img: icon6, url: 'https://www.wrappixel.com/templates/flexy-bootstrap-admin-template/?ref=376#demos' }
];
</script>
<template>
                ...
                <div class="d-flex flex-md-row flex-wrap justify-md-end justify-center ga-3">
                    <v-menu>
                        <template v-slot:activator="{ props }">
                            <v-btn variant="outlined" class="border-blue text-white text-h6 font-weight-medium" v-bind="props">
                    ...
                    <v-btn
                        class="purple-btn text-white text-h6 font-weight-medium"
                        href="https://www.wrappixel.com/templates/flexy-vuetify-dashboard/?ref=376#demos"
                        target="_blank"
                    >
